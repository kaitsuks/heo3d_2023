...
//Tämä versio ampuu 360 astetta, mutta vain vaakasuoraan!
[AddComponentMenu("Kaitsu/Creation/Object Shooter 3D V1")]
public class ObjectShooter3D_V1 : MonoBehaviour
{
	...
	void Update ()
	{
		   ...
		   && Time.time >= timeOfLastSpawn + creationRate)
		{
			...
			if(rigidbody != null)
			{
				...
				rigidbody.AddForce(newObject.transform.forward * shootSpeed, ForceMode.Impulse); //toimii myös newObjectille asetettujen position ja rotation kanssa
