...
public class Rotate3DGun3Kinematic : Physics3DObject
{
    ...
    void Start()
    {
        ...
        m_EulerAngleVelocity = new Vector3(30, 0, 0);
    }
    ...
    void Update()
    {
        ...
        //eulerLimit = n * eulerLimit; //TOIMII HUONOSTI
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(10, 50, 0, 0), "N = : " + n, style);
    }
