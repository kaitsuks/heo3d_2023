...
[AddComponentMenu("Kaitsu/Movement/Wander3D")]
[RequireComponent(typeof(Rigidbody))]
public class Wander3D : Physics3DObject
{
	[Header("Movement")]
	...
	private IEnumerator ChangeDirection()
	{
		while(true)
		{
			direction = Random.insideUnitSphere; //change the direction the player is going
