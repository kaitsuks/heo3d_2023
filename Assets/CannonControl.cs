...
public class CannonControl : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if (Input.GetKeyDown("i")) horizontalInput += rotDelta;
        if (Input.GetKeyDown("k")) horizontalInput -= rotDelta;
        ...
        Quaternion rotationChange = Quaternion.Euler(horizontalInput * rotationSpeed * Time.deltaTime, 0, 0);
        //muutetaan rotation
